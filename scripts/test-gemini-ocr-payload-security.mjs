...
/** structurally valid 1×1 baseline JPEG (SOI/SOF0/SOS/EOI) */
const JPEG_MIN =
  "/9j/4AAQSkZJRgABAQAAAQABAAD/2wBDABAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBD/wAALCAABAAEBAREA/8QAFAABAAAAAAAAAAAAAAAAAAAACP/aAAgBAQAAPwB//9k=";
const GIF87 = "R0lGODdhAQABAAAAADs=";
const GIF89 = "R0lGODlhAQABAAAAADs=";
/** RIFF/WEBP + VP8X canvas 1×1 */
const WEBP_MIN = "UklGRhYAAABXRUJQVlA4WAoAAAAAAAAAAAAAAAAA";
/** 1×1 24-bit BMP */
const BMP_MIN =
  "Qk06AAAAAAAAADYAAAAoAAAAAQAAAAEAAAABABgAAAAAAAQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA==";
/** minimal 1-page PDF 1.4 with xref/trailer/EOF */
const PDF_MIN =
  "";
