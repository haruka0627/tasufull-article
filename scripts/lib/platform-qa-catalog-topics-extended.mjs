...
export const QA_EXTENDED_TOPIC_SPECS = [
  ...
  { key: "business-directory", category: "listing", service: "platform", persona: "business", title: "ビジネスディレクトリ", summary: "事業者情報をディレクトリ形式で掲載できます。", questions: ["ビジネスディレクトリ", "業者名鑑", "business directory", "事業者検索", "B2Bディレクトリ"], keywords: ["ディレクトリ", "directory", "事業者名鑑"], relatedSlugs: ["business-listing", "contact-vendor"] },
