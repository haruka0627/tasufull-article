...
assert(storeSrc.includes("SCHEMA_VERSION = 4"), "SCHEMA v4");
...
assert(Store.SCHEMA_VERSION === 4, "store schema 4");

const all = Store.listProjects();
assert(all.every((p) => p.estimate && p.invoice), "estimate/invoice defaults");
