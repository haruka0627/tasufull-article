/**
 * Remove edge-connected dark background from header logo.
 * Input: images/tasful-header-logo-source.png
 * Output: images/tasful-header-logo.png (transparent PNG)
 */
...
const input = join(root, "images", "tasful-header-logo-source.png");
const output = join(root, "images", "tasful-header-logo.png");
