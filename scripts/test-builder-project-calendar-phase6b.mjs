...
assert(calJs.includes("tasu_builder_general_calendar_v1"), "personal calendar storage");
assert(calJs.includes("data-builder-cal-add-event") || calHtml.includes("data-builder-cal-add-event"), "add event button");
assert(calHtml.includes("data-builder-cal-modal"), "add event modal");
assert(calCss.includes("builder-cal-event"), "calendar css");
