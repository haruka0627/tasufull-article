...
| **6-B OAuth + Token Vault** | 秘書専用 GCP · connect / refresh · Supabase 暗号化保存 | 📋 未着手 |
| **6-C〜H** | Gmail read/write · Calendar · Contacts · Drive（段階実装） | 📋 未着手 |
...
**対象外（本フェーズ）:** Builder · TASFUL AI · Platform · Voice Core 変更
