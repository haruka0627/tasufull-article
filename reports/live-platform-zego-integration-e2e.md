...
| 16 | browser:audience-play | PASS — nodes=1 |
| 17 | browser:reconnect | PASS |
| 18 | browser:leave | PASS |
| 19 | browser:cleanup | PASS |
| 20 | signals:provider | PASS — PROVIDER_CONNECTING, PROVIDER_CONNECTED, PROVIDER_RECONNECTING, PROVIDER_CONNECTING, PROVIDER_RECONNECTING, PROVIDER_RECONNECTED, PROVIDER_CONNECTED, PROVIDER_RECONNECTED, PROVIDER_DISCONNECTED, PROVIDER_RECONNECTING, PROVIDER_RECONNECTING |
| 21 | signals:broadcast | PASS — BROADCAST_PROVIDER_STARTING, BROADCAST_PROVIDER_STARTED, BROADCAST_PROVIDER_STARTING, BROADCAST_PROVIDER_STARTED |
...
- **signals:provider:** PASS — PROVIDER_CONNECTING, PROVIDER_CONNECTED, PROVIDER_RECONNECTING, PROVIDER_CONNECTING, PROVIDER_RECONNECTING, PROVIDER_RECONNECTED, PROVIDER_CONNECTED, PROVIDER_RECONNECTED, PROVIDER_DISCONNECTED, PROVIDER_RECONNECTING, PROVIDER_RECONNECTING
- **signals:broadcast:** PASS — BROADCAST_PROVIDER_STARTING, BROADCAST_PROVIDER_STARTED, BROADCAST_PROVIDER_STARTING, BROADCAST_PROVIDER_STARTED
