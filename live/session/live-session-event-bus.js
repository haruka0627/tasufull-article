/**
 * TLV Live Session — Event Bus（SDK 非依存）
 * Phase2-01 Skeleton
 */
(function (global) {
  "use strict";

  class TlvLiveSessionEventBus {
    constructor() {
    ...
    emit(event, payload) {
      ...
      for (const entry of toRun) {
        try {
          ...
          console.error(`[TlvLiveSessionEventBus] handler error (${name}):`, err);
        }
  ...
  global.TlvLiveSessionEventBus = TlvLiveSessionEventBus;
